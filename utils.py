...
def init_arg_parser():
    ...
    #### Model configuration ####
    arg_parser.add_argument('--lstm', choices=['lstm', 'gru'], default='lstm', help='Type of LSTM used, currently only standard LSTM cell is supported')
    ...
    arg_parser.add_argument('--lstm_init', default=False, action='store_true', help='Use lstm initialization')
